...
-- CreateEnum
CREATE TYPE "InventoryMovementType" AS ENUM ('INITIAL_STOCK', 'PURCHASE', 'SALE', 'RETURN', 'ADJUSTMENT', 'DAMAGE');
...
-- CreateEnum
CREATE TYPE "PaymentTransactionType" AS ENUM ('CREATE', 'AUTHORIZE', 'CAPTURE', 'FAIL', 'REFUND', 'WEBHOOK');
