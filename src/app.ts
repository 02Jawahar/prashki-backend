...
export function createApp() {
  ...
  app.use(
    cors({
      ...
      // Listed explicitly rather than reflecting whatever is asked for. The
      // CSRF header has to be here or the browser will not send it.
  ...
  /**
   * CSRF. Issued to everyone, enforced on every state-changing request that
   * relies on cookies — see the middleware for why SameSite alone is not
   * enough once the storefront and API are on different domains.
   */
